...
RELEASE=-O3 -fstrict-aliasing -ffast-math -DNDEBUG -flto -msse -msse2 -msse3 -mssse3 -msse4 -msse4.1 -msse4.2 -march=native -fomit-frame-pointer #-fprofile-generate #-fprofile-use
